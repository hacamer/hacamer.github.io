...
echo "[8] 升级Hexo及插件（慎用）"
echo "[9] 重新安装依赖"
echo "[10] 安装butterfly主题"
echo "[11] 安装volantis主题"
echo "[12] 安装Hexo-Admin(用于管理或撰写Hexo博文，适合初学者使用)"
echo "=============以下功能为全局指令================"
echo "[13] 安装ssh密钥"
echo "[14] 验证ssh密钥"
echo "[15] 切换npm源为阿里镜像"
...
git clone git@github.com:hacamer/Hexo-source.git Hexo # 记得替换仓库URL为自己的源码存放仓库
cd Hexo
printf "\033[32mINFO \033[0m 正在将npm源替换为阿里云镜像 ...\n"
npm config set registry https://registry.npm.taobao.org # 替换NPM源为阿里镜像
...
git config --global user.name "hacamer" # 记得替换用户名为自己的
git config --global user.email "hcamer145@gmail.com" # 记得替换邮箱为自己的
ssh-keygen -t rsa -C hcamer145@gmail.com # 记得替换邮箱为自己的
